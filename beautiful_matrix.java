...
public class beautiful_matrix {
     ...
     * some integer i (1 ≤ i < 5).
     * Swap two neighboring matrix columns, that is, columns with indexes j and j +
     * 1 for some integer j (1 ≤ j < 5).
     ...
     * that is located on the intersection of the i-th row and the j-th column. It
     * is guaranteed that the matrix consists of 24 zeroes and a single number one.
     *
     * Output
     * Print a single integer — the minimum number of moves needed to make the
     * matrix beautiful.
     */
